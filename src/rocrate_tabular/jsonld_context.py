...
class JSONLDContextResolver:
    ...
    def __init__(self, context=None):
        ...
        """
        self.raw_context = context if context is not None else "https://w3id.org/ro/crate/1.1/context"
        ...
        try:
            ...
            for ctx in contexts_to_process:
                if isinstance(ctx, str):
                    ...
                    raise ContextResolutionException(f"Unsupported context type: {type(ctx)}")
    ...
    def _merge_context(self, context: Union[Dict, List, str]):
        ...
        if isinstance(context, list):
            ...
            raise ContextResolutionException(f"Unsupported context type: {type(context)}")
    ...
    def resolve_term(self, term: str) -> str:
        ...
        if ':' in term:
            ...
            if prefix in self.context_map:
                print(f"Found prefix '{prefix}' in context map: {self.context_map[prefix]}")
